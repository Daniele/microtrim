...
set output '../accuracy_fastp.eps'
set title "HTSeq results for FastP baseline" 
...
plot '../data/accuracy_fastp.dat' using 2:xtic(1) ti col, '' u 3 ti col, '' u 4 ti col, '' u 5 ti col
